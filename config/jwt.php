...
return [
    ...
    */
    ...
    | Meaning that if you have a clock skew on your your server's clock,
    | you will be able to configure a leeway to account for it.
    |
    ...
    */
    ...
    'decrypt_cookies' => (bool) env('JWT_DECRYPT_COOKIES', false),
